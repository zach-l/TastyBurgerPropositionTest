<div id="updates_sign_up" class="updates_sign_up ">
	<img style="display: inline-block;  padding: 12px 0px 0px 8px;" src="../img/speech_bubble.png"/>	
	<div id="sign_up" style="display: inline-block; vertical-align: top; padding: 12px 9px; color: white;"><a>Sign up for Updates HERE!</a></div>	
